...
SAAS_AUTH_INTROSPECTION_URL = os.getenv("SAAS_AUTH_INTROSPECTION_URL", "").strip()
SAAS_AUTH_INTROSPECTION_TIMEOUT_SECONDS = float(
    os.getenv("SAAS_AUTH_INTROSPECTION_TIMEOUT_SECONDS", "2")
)
