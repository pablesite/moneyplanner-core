...
urlpatterns = [
    ...
    path("benchmark/", PortfolioBenchmarkView.as_view(), name="portfolio-benchmark"),
    path("risk/", PortfolioRiskView.as_view(), name="portfolio-risk"),
    path("decisions/", PortfolioDecisionsView.as_view(), name="portfolio-decisions"),
