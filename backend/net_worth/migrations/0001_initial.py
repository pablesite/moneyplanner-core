    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                "ordering": ["-updated_at"],
                "indexes": [
                    models.Index(fields=["user", "category"], name="net_worth_a_user_id_16359c_idx")
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                "ordering": ["-updated_at"],
                "indexes": [
                    models.Index(fields=["user", "category"], name="net_worth_l_user_id_91f0e0_idx")
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user", "snapshot_date"], name="net_worth_n_user_id_884495_idx"
                    )
                ],
                "constraints": [
