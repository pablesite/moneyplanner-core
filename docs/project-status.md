...
| Movimientos | Manual | Remate manual de la vista para dejarla en estado v1 final. Seguimiento operativo por cuentas en `core/docs/operations/movements-user1-review-tracker.md` (usuario 1: 106 cuentas totales, 19 ya revisadas). Cierre de categorizacion final completado para las 19 cuentas revisadas (incluye `477 Fondo Monetario ING`, `479 ETF MSCI World`, `480 ETF REIT Real Global Real State`, `482 Cartera Ahorro MyInvestor`, `483 Cartera Ahorro MyInvestor (Compartida)` y `486 Cripto - ETH (Metamask)`). | Se define durante la revisión. |
