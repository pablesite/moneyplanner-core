...
| Investment portfolio | High | 🟡 | Phases 1-2 complete: domain foundation plus confirmed mappings, persisted daily closes, manual/legacy total valuations, explicit precedence, freshness and provider health. Local reconciliation produced 2,543 crypto closes and 831 legacy daily values; securities without trustworthy identifiers remain explicit mapping issues. Phase 3 is next. |
