...
| Movimientos | Manual | Remate manual de la vista para dejarla en estado v1 final. Seguimiento operativo por cuentas en `core/docs/operations/movements-user1-review-tracker.md` (usuario 1: 106 cuentas totales, 35 ya revisadas). Cierre de categorizacion final completado para las 35 cuentas revisadas; bloque de préstamos personales cerrado (incluida consolidación de `iPhone 15 Ana` en `Préstamo - Iphone 15 Pro` y eliminación de la cuenta obsoleta). | Se define durante la revisión. |
