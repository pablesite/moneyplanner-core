...
| Movimientos | Manual | Remate manual de la vista para dejarla en estado v1 final. Seguimiento operativo por cuentas en `core/docs/operations/movements-user1-review-tracker.md` (usuario 1: 106 cuentas totales, 31 ya revisadas). Cierre de categorizacion final completado para las 31 cuentas revisadas; ultima cuenta cerrada: `481 Tarjeta ING` (recategorizacion de subcategorias de consumo). | Se define durante la revisión. |
