...
| Limpieza legacy residual | Media | 🔄 | Inventario en `roadmap/product-roadmap.md`. Queda: `compat.*` en capabilities (4 ficheros consumidores directos). Retirados: Introducción de Datos, alias `investment_purchase`, campos escalares de aportaciones (migración 0042), import externo de `net_worth.services` desde `portable_data.py` (2026-05-20). Fallback Budget/check-ins: diseño intencional. |
