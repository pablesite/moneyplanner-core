...
| Movimientos | Manual | Remate manual de la vista para dejarla en estado v1 final. Seguimiento operativo por cuentas en `core/docs/operations/movements-user1-review-tracker.md` (usuario 1: 106 cuentas totales, 27 ya revisadas). Cierre de categorizacion final completado para las 27 cuentas revisadas (incluye `477 Fondo Monetario ING`, `479 ETF MSCI World`, `480 ETF REIT Real Global Real State`, `482 Cartera Ahorro MyInvestor`, `483 Cartera Ahorro MyInvestor (Compartida)`, `486 Cripto - ETH (Metamask)`, `485 Cripto - Bots de Grids (Pionex)`, `38 Urbanitae`, `40 ViaInvest`, `31 Healthcare`, `28 ETF Physical Gold USD (Acc)`, `35 Small Caps`, `39 Water` y `33 MyInv. Indexado Global (MSCI)`). | Se define durante la revisión. |
