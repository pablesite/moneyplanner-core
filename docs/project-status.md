...
| Investment portfolio | High | 🟡 | Phase 1 domain foundation complete: one global portfolio, safe idempotent bootstrap, containers, custom/canonical instruments, positions, immutable historical ownership and independent coverage axes. Local migration covers 23/23 primary-user investment assets; 10 missing legacy ownership links remain explicit `needs_review` issues. Phase 2 is next. |
