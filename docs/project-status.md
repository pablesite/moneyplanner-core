...
| Investment portfolio | High | 🟡 | Phases 1-5 complete: domain, valuation, coverage-gated performance, SaaS workspace, atomic operations/corporate actions and generic preview-first CSV import. Migrated positions explicitly choose reconstructed history or a cutoff without rewriting ledger history. Allocation/rebalancing is next in Phase 6. |
