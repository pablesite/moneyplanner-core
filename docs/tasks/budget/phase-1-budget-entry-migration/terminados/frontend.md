...
1. In scope
   ...
   Replicar el cambio equivalente en `frontend/` por la regla de espejado Core -> SaaS.
2. Out of scope
...
1. Diagnosis
   ...
   Confirmar todos los puntos de navegacion Core y SaaS que hoy enlazan a `/introduccion-datos`.
2. Change implementation
   ...
   Reflejar el mismo comportamiento en el frontend SaaS salvo diferencias documentadas de empaquetado.
3. Validation
   Validar lint, format, typecheck y unit tests en Core frontend y SaaS frontend.
...
- [x] `docs/project-status.md` — reflejar el espejo SaaS y el avance de consolidacion funcional v1
...
2. Dejar enlaces huérfanos a `/introduccion-datos` en Core o SaaS. Mitigacion: auditar router, nav, guide y empty states antes de cerrar.
...
- [x] Mirror Core -> SaaS aplicado o excepcion documentada
