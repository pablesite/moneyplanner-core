...
## Cierre implementado
1. `DataInputView.vue` reducida a ensamblador fino (16 lineas) en Core.
...
5. Tests unitarios nuevos para filtros:
   - `domains/data-input/__tests__/useDataInputFilters.spec.ts` (Core)
6. Replicacion Core aplicada en la misma estructura.
...
2. Core: verde en `lint`, `typecheck`, `test:coverage` (>=80% en todas las metricas).
