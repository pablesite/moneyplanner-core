...
6. Beta, correlation, VaR and risk contribution ship **declared and unavailable**, with their shape fixed in the contract so adding them later breaks nobody. All of them need a per-instrument market series that the illiquid part of the portfolio does not have.
